...
<table class="report" width="100%" cellspacing="2" cellpadding="2" border="1" style="font-size:14px">
    <tr>
    	<th class="priceheading" style="width:180px">जिल्ला</th>
        <th class="priceheading" style="width:240px">स्रोत केन्द्र/नर्सरीको नाम</th>
        <th class="priceheading" style="width:380px">
            <table>
                <tr>
