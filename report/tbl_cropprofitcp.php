...
<div class="hdr">
            ...
            <div class="sitename" style="float:left">
            	...
            	<h4>बालीको क्षेत्रफल(सिंचित)(हे): <? echo $rec['cropIrrigatedAreaHector'];?></h4>
            </div>
            <div class="sitename" style="float:left">
                <h4>बालीको क्षेत्रफल(असिंचित)(हे): <? echo $rec['cropUnirrigatedAreaHector'];?></h4>
...
<table class="report" width="75%" cellspacing="2" cellpadding="2" border="1" style="font-size:14px">
    <tr>
        ...
        <th class="priceheading" style="width:180px">जम्मा लागत(Rs)</th>
        <th class="priceheading" style="width:400px">कैफियत</th>
    </tr>
    <?
	$cp=$program->getCommoditiesByParentId($programId); //print_r($conn->fetchArray($rate));
