                          ...
                          <?php } ?>                          
                            ...
                            <tr>
                              ...
                              <td>
                              	...
                              	<select name="user_type" style="width:180px" onchange="disableDistrict(this, '<?=USERDISTRICT;?>');">
                            ...
                            <tr id="hidedist" style="display:none">
                              <td>&nbsp;</td>
                              <td class="tahomabold11"><strong> District :</strong></td>
                              <td>
                              	<label for="title"></label>
                              	<select name="district" style="width:180px" id="dist">
                            ...
                            <tr><td></td></tr>
                            <? if(isset($_GET['id']) and $user_type!=USERDISTRICT)
							{?>
                            	<script> $('#hidedist').hide(); </script>
                            <? }
							else if(isset($_GET['id']) and $user_type==USERDISTRICT)
							{?>
                            	<script> $('#hidedist').show(); </script>
                            <? }?>
                            <tr>
