...
if (isset($_POST['save']))
{
 ...
 if ($_POST['linkType'] == "Contents Page")
 {
	...
	$shortcontentsnp = $_POST['shortcontentsnp'];
  	$contentsnp = $_POST['contentsnp'];
 }
 ...
 if (isset($_POST['id']))
 {
  ...
  else if ($_POST['linkType'] == "List")
  {
   ...
   {
   	$groups->saveListSub($_POST['listId'], $_POST['listTitle'], $_POST['listTitlenp'], $_POST['listUrlTitle'], $_POST['id'], $_POST['listShortDescription'], $_POST['listShortDescriptionnp'], $_POST['listDescription'], $_POST['listDescriptionnp'], $_POST['listMain'], $_POST['listWeight']);
   ...
   else
   {
   	...
   	{
   		$newListId = $groups->saveListSub("", $_POST['listTitle'], $_POST['listTitlenp'], $_POST['listUrlTitle'], $_POST['id'], $_POST['listShortDescription'], $_POST['listShortDescriptionnp'], $_POST['listDescription'], $_POST['listDescriptionnp'], $_POST['listMain'], $_POST['listWeight']);
  ...
  if($groups -> isUnique($_POST['id'], $_POST['urlname']) && !empty($_POST['urlname']))
	{
		$groups->save($_POST['id'], $_POST['name'], $_POST['namenp'], $_POST['urlname'], "",  $_POST['parentId'], "", $shortcontents, $shortcontentsnp, $contents, $contentsnp, $_POST['weight'], $_POST['pageTitle'], $_POST['pageKeyword'], $_POST['featured'], $_POST['display']);
...
else //add new code goes here...
{
	...
	elseif($_POST['linkType'] == "select")
 	...
 	if(empty($msg))
	{
		$newId = $groups->save("", $_POST['name'], $_POST['namenp'], $_POST['urlname'], $_GET['groupType'], $_POST['parentId'], $_POST['linkType'], $shortcontents, $shortcontentsnp, $contents, $contentsnp, $_POST['weight'], $_POST['pageTitle'], $_POST['pageKeyword'], $_POST['featured'], $_POST['display']);
		...
		else if ($_POST['linkType'] == "List")
		{
			...
			if (empty($msg))
			{
				$newListId = $groups->saveListSub("", $_POST['listTitle'], $_POST['listTitlenp'], $_POST['listUrlTitle'], $newId, $_POST['listShortDescription'], $_POST['listShortDescriptionnp'], $_POST['listDescription'], $_POST['listDescriptionnp'], $_POST['listMain'], $_POST['listWeight']);
				$ext = saveListingImage($newListId);
				if (!empty($ext))
					$groups->updateImage($newListId, $newListId ."." .$ext);
