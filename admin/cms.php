                            ...
                            <td><form action="<?php echo $formLink; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    	English: <input type="text" name="name" value="<?php echo $groupRow['name']; ?>" class="text" onchange="copySame('urlname', this.value);"> &nbsp;
                                  		Nepali: <input type="text" name="namenp" value="<?php echo $groupRow['namenp']; ?>" class="text" />
                                    </td>
                                  </tr>
																	<tr>
