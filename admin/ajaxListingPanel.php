...
<div>
  ...
  <?php
    ...
    <span>
  		English: <input type="text" name="listTitle" id="listTitle" value="<?php echo $listRow['name']; ?>" class="text" onchange="copySame('listUrlTitle', this.value);" />
        Nepali: <input type="text" name="listTitlenp" id="listTitle" value="<?php echo $listRow['namenp']; ?>" class="text" />
 	</span>
	<br class="clearboth" />
    <br>
  ...
  <input type="text" name="listUrlTitle" id="listUrlTitle" value="<?php echo $listRow['urlname']; ?>" class="text" onchange="copySame('listUrlTitle', this.value);" />
	...
	<div>
		<div style="float:left; width:49%;">
    		<p>Summary(English)</p>
            <textarea name="listShortDescription" rows="10" cols="45"><?php echo $listRow['shortcontents']; ?></textarea>
		</div>
    	<div style="float:right; width:49%">
			<p>Summary(Nepali)</p>
			<textarea name="listShortDescriptionnp" rows="10" cols="45"><?php echo $listRow['shortcontentsnp']; ?></textarea>
		</div>
