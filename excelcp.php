...
if($typeId==DISTRICT){
	$record=$program->getTableDataByTypeAndFiscalYearAndDistrict($typeId,$fiscalYear,$district);
	...
	$record=$program->getTableDataByTypeAndFiscalYearAndCropListAndDistrict($typeId,$fiscalYear,$_POST['cropName'],$district);
	//Store it into the array
	while ($row = mysql_fetch_array($record))
	{
	...
	fputcsv($output, array('Fiscal Year','Crop Name','Total Area(H)','Total Production(T)',
...
{
	$record=$program->getTableDataByTypeAndFiscalYearAndCropListAndMonthAndDistrict($typeId,$fiscalYear,$_POST['cropName'],$_POST['month'],$district);
	//Store it into the array
	while ($row = mysql_fetch_array($record))
	{
